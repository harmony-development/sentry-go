...
**Godoc:** https://godoc.org/github.com/harmony-development/sentry-go/gin

**Example:** https://github.com/harmony-development/sentry-go/tree/master/example/gin

## Installation

```sh
go get github.com/harmony-development/sentry-go/gin
```
...
`sentrygin` attaches an instance of `*sentry.Hub` (https://godoc.org/github.com/harmony-development/sentry-go#Hub) to the `*gin.Context`, which makes it available throughout the rest of the request's lifetime.
