...
**Godoc:** https://godoc.org/github.com/harmony-development/sentry-go/martini

**Example:** https://github.com/harmony-development/sentry-go/tree/master/example/martini

## Installation

```sh
go get github.com/harmony-development/sentry-go/martini
```
...
import (
    ...
    sentrymartini "github.com/harmony-development/sentry-go/martini"
...
`sentrymartini` maps an instance of `*sentry.Hub` (https://godoc.org/github.com/harmony-development/sentry-go#Hub) as one of the services available throughout the rest of the request's lifetime.
