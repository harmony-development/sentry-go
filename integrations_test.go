	...
	tests := []struct {
		...
		},
		{
			...
			info: &debug.BuildInfo{
				...
				Deps: []*debug.Module{
					{
						Path:    "github.com/harmony-development/sentry-go",
						Version: "v0.5.1",
					},
					{
			...
			want: map[string]string{
				"my/module": "(devel)",
				"github.com/harmony-development/sentry-go": "v0.5.1",
		...
		},
		{
			...
			want: map[string]string{
				"my/module": "(devel)",
				"github.com/harmony-development/sentry-go": "v0.5.1 => pkg/sentry",
			},
		},
		{
