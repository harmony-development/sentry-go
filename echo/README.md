...
**Godoc:** https://godoc.org/github.com/harmony-development/sentry-go/echo

**Example:** https://github.com/harmony-development/sentry-go/tree/master/example/echo

## Installation

```sh
go get github.com/harmony-development/sentry-go/echo
```
...
`sentryecho` attaches an instance of `*sentry.Hub` (https://godoc.org/github.com/harmony-development/sentry-go#Hub) to the `echo.Context`, which makes it available throughout the rest of the request's lifetime.
